...
class module_controller {
    ...
    static function getCheckDBUpdates() {
        ...
        // Updates
        $v_update_sql = $zdbh->prepare("UPDATE x_modules SET mo_version_in=10123 WHERE mo_name_vc='" . ui_module::GetModuleName() . "'");
	...
	static function getPackageSelection() {
		$toReturn ="";
		$packages= new xml_reader(fs_filehandler::ReadFileContents('modules/zantasticox/packages/packages.xml'));
		$packages->Parse();
